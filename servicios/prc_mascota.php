...
$id_tipomasc = isset($_GET['id_tipomasc']) ? $_GET['id_tipomasc'] : '';
$id_mun= isset($_GET['id_mun']) ? $_GET['id_mun'] : '';
$id_usuario = isset($_GET['id_usuario']) ? $_GET['id_usuario'] : '';
$residencia = utf8_decode(isset($_GET['residencia']) ? $_GET['residencia'] : '');
$state_res = isset($_GET['state_res']) ? $_GET['state_res'] : '';
